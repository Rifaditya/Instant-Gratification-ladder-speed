...
public class LadderSpeedRules {
    ...
    public static final GameRule<Integer> CLIMB_SPEED = DynamicGameRuleManager.integerRule("ladderspeed.climb_speed", CATEGORY, 100)
    ...
    public static final GameRule<Integer> SPRINT_MULTIPLIER = DynamicGameRuleManager.integerRule("ladderspeed.sprint_multiplier", CATEGORY, 150)
    ...
    public static final GameRule<Integer> DESCEND_SPEED = DynamicGameRuleManager.integerRule("ladderspeed.descend_speed", CATEGORY, 100)
    ...
    public static final GameRule<Boolean> SNAP_DESCEND = DynamicGameRuleManager.booleanRule("ladderspeed.snap_descend", CATEGORY, true)
