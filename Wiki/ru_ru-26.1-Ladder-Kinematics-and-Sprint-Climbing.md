...
# 🏃 Кинематика лестниц и спринт-подъем (MC 26.1)
...
## 2. Игровой процесс и пошаговый алгоритм
...
## 3. Математическая кинематика и формулы
...
## 4. Визуальная диаграмма состояний и архитектура
...
* [[Вернуться к обзору MC 26.1|ru_ru-26.1-Home]]
* [[26.1 Быстрый спуск и скольжение|ru_ru-26.1-Snap-Descend-and-Slide-Controls]]
* [[26.1 Конфигурация и игровые правила|ru_ru-26.1-Configuration-and-GameRules]]
* [[26.1 Архитектура и анализ миксинов|ru_ru-26.1-Architecture-and-Mixins]]
