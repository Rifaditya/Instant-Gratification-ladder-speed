...
# 🪜 Minecraft 26.3 — Kecepatan Tangga (Ladder Speed)
...
1. [[26.3 Kinematika Tangga & Panjat Sprint|id_id-26.3-Ladder-Kinematics-and-Sprint-Climbing]]
   - Physics scaling math, upward velocity formulas, sprint detection, and friction calculations.
2. [[26.3 Turun Cepat & Kontrol Meluncur|id_id-26.3-Snap-Descend-and-Slide-Controls]]
   - Pitch angle trigger thresholds ($> 45^\circ$), snap slide speed ($-0.4\text{ b/t}$), and sneak anchoring safety.
3. [[26.3 Konfigurasi & GameRules Dinamis|id_id-26.3-Configuration-and-GameRules]]
...
5. [[26.3 Pengaturan Pengembang & Toolchain|id_id-26.3-Developer-Setup-and-Building]]
