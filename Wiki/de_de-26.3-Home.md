...
# 🪜 Minecraft 26.3 — Leitergeschwindigkeit (Ladder Speed)
...
1. [[26.3 Leiter-Kinematik & Sprint-Klettern|de_de-26.3-Ladder-Kinematics-and-Sprint-Climbing]]
   - Physics scaling math, upward velocity formulas, sprint detection, and friction calculations.
2. [[26.3 Schneller Abstieg & Rutschsteuerung|de_de-26.3-Snap-Descend-and-Slide-Controls]]
   - Pitch angle trigger thresholds ($> 45^\circ$), snap slide speed ($-0.4\text{ b/t}$), and sneak anchoring safety.
3. [[26.3 Konfiguration & dynamische GameRules|de_de-26.3-Configuration-and-GameRules]]
   - Complete reference table of all 4 GameRules under `ladderspeed:category`, bounds, and default values.
4. [[26.3 Architektur & Mixin-Analyse|de_de-26.3-Architecture-and-Mixins]]
   - Bytecode injections in `LivingEntityMixin`, stateless helper separation in `ClimbingLogic`, and registration lifecycle.
5. [[26.3 Entwickler-Setup & Toolchain|de_de-26.3-Developer-Setup-and-Building]]
