...
# 🪜 Minecraft 26.3 — Instant Gratification: Ladder Speed

> 📌 **Repository Source Disclaimer**: The documentation in this Wiki reflects the **current source code state in the repository**, which may include recent unreleased commits or developmental features ahead of public release builds on CurseForge and Modrinth.

Welcome to the dedicated documentation tree for **Ladder Speed on Minecraft 26.3** (Mod Version `1.0.0+build.1+26.3`).
...
1. [[Ladder Kinematics & Sprint Climbing|26.3-Ladder-Kinematics-and-Sprint-Climbing]]
   - Physics scaling math, upward velocity formulas, sprint detection, and friction calculations.
2. [[Snap Descend & Slide Controls|26.3-Snap-Descend-and-Slide-Controls]]
...
4. [[Architecture & Mixin Implementations|26.3-Architecture-and-Mixins]]
